...
export const PROVIDERS = {
  ...
  copilot:    { label:"Copilot",    icon:"⬡",  color:"#6e40c9", local:false, costPer1k:0.002,  defaultModel:"gpt-4o",                    baseUrl:"https://api.githubcopilot.com",           pingPath:null, signInUrl:"https://github.com/login/device/code",          apiKeyHint:"gho_...",    models:["gpt-4o","gpt-4o-mini","o1-mini","claude-3.5-sonnet"],                                                           hint:"Requires an active GitHub Copilot subscription. OAuth token needed (not PAT)." },
